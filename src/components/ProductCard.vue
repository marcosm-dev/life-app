<template>
    <q-card class="q-mb-lg shadow-12 rounded-card row items-end">
      <q-card-section class="col-12">
        ...
        <q-separator v-if="product.price && product.stock" size="1px" spaced="5px" />
      </q-card-section>
      <q-card-actions v-if="product.price && product.stock" class="col-12 items-end no-padding text-no-wrap">
        <ProductQuantity
          :product="state"
